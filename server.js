...
Build(function() {
	Build.load([ 'buildnode::build.mvc.server.DynamicServer', 'buildnode::build.mvc.controller.AuthenticationController', 'buildnode::build.mvc.controller.UserController', 'buildnode::build.mvc.controller.TestController' ], function() {
