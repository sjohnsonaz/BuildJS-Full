 ...
 */
Build('build.widget.user.UserCreateForm', [ 'build::build.form.Form', 'build::build.ui.element.Div', 'build::build.form.Text', 'build::build.form.Password', 'build::build.form.Button', 'build::build.form.Submit',
