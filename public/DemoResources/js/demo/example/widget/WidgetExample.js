 ...
 */
Build('demo.example.widget.WidgetExample', [ 'build::build.ui.Container', 'build::build.ui.element.Header1', 'demo::demo.example.widget.CarouselExample', 'demo::demo.example.widget.TreeExample', 'demo::demo.example.widget.TableExample',
		'demo::demo.example.widget.ProgressBarExample', 'demo::demo.example.widget.ImageExample', 'demo::demo.example.widget.ModalExample', 'demo::demo.example.widget.CollapsibleExample', 'demo::demo.example.widget.CodeExample',
		'demo::demo.example.widget.MediaExample', 'demo::demo.example.widget.CanvasExample', 'build::build.ui.element.Paragraph'
