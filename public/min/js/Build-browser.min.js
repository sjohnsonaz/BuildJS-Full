var build=build||{},Build=build.Build=function(){function a(e){switch(typeof e){case "function":a.onload.apply(a.onload,arguments);break;case "string":a.define.apply(a.define,arguments)}}function B(e,a){for(var b=e.split("."),c=p.root,d=c,h="",k=0,f=b.length;k<f;k++)h=b[k],c[h]=c[h]||{},d=c,c=c[h];A[b[0]]=p.root[b[0]];return d[h]=a}function b(e,a){for(var b in a)a.hasOwnProperty(b)&&(e[b]=e[b]||a[b]);return e}function d(e,a){for(var b in a)a.hasOwnProperty(b)&&(e[b]=a[b]);return e}function f(e,a,
g){a?(g=g||{},Object.keys(e.prototype).length&&d(g,e.prototype),e.prototype=Object.create(a.prototype),d(e.prototype,g),e.prototype.constructor=e,b(e,a),e.$parent=a):b(e.prototype,g)}function s(a,l,g,c,d,h){$construtor=h?singletone(l):l;b(l,c);f(l,d,g);l.$name=a;q[a]=l;B(a,l);return l}function u(){for(var a=Object.keys(r);a.length;){var b=a.pop();C(b)}r={};t&&(m.queue.call(),m.queue.clear())}function C(a){var b=r[a];delete r[a];if(b){var g;b(function(b){q[b.$extends]||C(b.$extends);g=s(a,b.$constructor,
...
g)}function F(a,b){var d,c=a.split("::");1<c.length?(d=y[c[0]]||y.main,a=c[1]):d=y.main;q[a]?b():(d=E(a,d),c=D(a),w[a]=!0,G(c,d,function(){delete w[a];b()}))}function G(b,d,g){switch(p.name){case "browser":var c=document.createElement("script");c.id=b;c.src=d;c.addEventListener("load",g,!1);document.getElementsByTagName("head")[0].appendChild(c);break;case "node":b=require(d),p.override&&"function"!==typeof b||b(a),g()}}function m(a){if("undefined"!=typeof jQuery)jQuery(a);else if(m.queue)m.queue.add(a);
else switch(m.queue=new v,m.queue.add(a),p.name){case "browser":window.addEventListener("load",function(){t=!0;var a=Object.keys(z);a.length?n(a,function(){u()}):u()},!1);break;case "node":u()}}var t=!1,w={},r={},y={main:"/"},z={},A={},p=function(){return"undefined"!==typeof window?{name:"browser",root:window}:"undefined"!==typeof process?(t=!0,module.exports=a,{name:"node",root:A,override:"hidden",processOverride:function(){this.root=process;this.override="process";process.Build=a},globalOverride:function(){this.root=
GLOBAL;this.override="global";GLOBAL.Build=a}}):{name:null,root:null}}(),q={};v.prototype={add:function(a){this.done?a():this.queue.push(a)},call:function(){if(!this.done){for(;this.queue.length;)this.queue.pop()();this.done=!0}},clear:function(){this.done=!1;this.queue=[]}};var x=0;n.queue=new v;m.queue=null;a.root=A;a.environment=p;a.namespace=B;a.copyReplace=d;a.copyNoReplace=b;a.inherit=f;a.singleton=function(a){var b=void 0;return function(){if(!b){var d=arguments,c=function(){return a.apply(this,
d)};c.prototype=a.prototype;b=new c}return b}};a.definitions=q;a.assemble=s;a.paths=y;a.define=function(a,b,d){t||delete z[a];for(var c=[],f=0,h=b.length;f<h;f++){var k=b[f];q[k]||(r[k]||w[k]||z[k])||c.push(k)}r[a]=d;if(c.length)if(t)n(c,function(){});else for(f=0,h=c.length;f<h;f++)z[c[f]]=!0};a.nameToCss=D;a.nameToFileName=E;a.load=n;a.loadScript=G;a.CallbackQueue=v;a.onload=m;return a}();
